...
public class Game extends Activity {
	...
	private int y = 0;
	int b, a;
	private String W, wore, wor, name1, name2;
	private int n = 1;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		wore = inte.getExtras().getString("word");
		loadP();
		final MediaPlayer s_button = MediaPlayer.create(this, R.raw.button);
		name1 = inte.getExtras().getString("name1");
		name2 = inte.getExtras().getString("name2");
		String w = wor.toUpperCase(Locale.US);
		W = w.trim();
		n = W.length();
		...
		guess.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (good == 0) {
					...
					if (!(n1 == n2)) {
						...
						if (flag == 1) {
							...
							if (flagb == n1) { // User wins
								...
								MediaPlayer boo = MediaPlayer.create(Game.this,
										R.raw.boo);
								AlertDialog.Builder al = new AlertDialog.Builder(
										Game.this);
					...
					x--;
					AlertDialog.Builder al = new AlertDialog.Builder(Game.this);
	...
	private void loadP() {
		...
		name1 = sp.getString("name1", "Player1");
		name2 = sp.getString("name2", "Player2");
		y1 = sp.getInt("y1", 0);
		y2 = sp.getInt("y2", 0);
		y3 = sp.getInt("y3", 0);
		y4 = sp.getInt("y4", 0);
