...
public class Cvpgame2 extends Activity {
	private int x = 0;
	private int n = 1;
	int b, a;
	private String wor, wore;
	private int countg = 1;
	private String guesses[] = new String[100];
	static Tracker t;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		TextView ent = (TextView) findViewById(R.id.enter_guess);
		...
		give_up.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				AlertDialog.Builder al = new AlertDialog.Builder(Cvpgame2.this);
